...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApplyTracking.resume'
        db.add_column(u'resume_applytracking', 'resume',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['resume.Resume'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApplyTracking.resume'
        db.delete_column(u'resume_applytracking', 'resume_id')
