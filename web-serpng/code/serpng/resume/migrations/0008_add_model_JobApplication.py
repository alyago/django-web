...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('job_applications', (
            ...
            ('refind_key', self.gf('django.db.models.fields.CharField')(max_length=40, primary_key=True)),
            ('mobolt_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10)),
            ('questions', self.gf('django.db.models.fields.CharField')(max_length=10000)),
        ))
        db.send_create_signal(u'resume', ['JobApplication'])
    ...
    models = {
        ...
        u'resume.jobapplication': {
            'Meta': {'object_name': 'JobApplication', 'db_table': "'job_applications'"},
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'mobolt_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '10'}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'questions': ('django.db.models.fields.CharField', [], {'max_length': '10000'}),
            'refind_key': ('django.db.models.fields.CharField', [], {'max_length': '40', 'primary_key': 'True'})
        },
