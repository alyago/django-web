...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ApplyTracking'
        db.create_table('resume_applytracking', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_id', self.gf('django.db.models.fields.IntegerField')(max_length=11, null=True, blank=True)),
            ('user_email', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('session', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('apply_source', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('user_agent', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('resume_type', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('filename', self.gf('django.db.models.fields.CharField')(default='', max_length=512, null=True, blank=True)),
            ('advertiser_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('campaign_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('refind_key', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True)),
            ...
            ('job_location', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('search_keyword', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('search_location', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('search_position', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('cpc', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('resume', ['ApplyTracking'])

    def backwards(self, orm):
        # Deleting model 'ApplyTracking'
        db.delete_table('resume_applytracking')
